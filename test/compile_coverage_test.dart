...
// imported it, so the suite stayed green while a screen was broken and only a
// real `flutter build` surfaced it.
//
...
import 'package:vibetube/services/permissions.dart';
...
import 'package:vibetube/utils/text_utils.dart';
...
void main() {
  test('every library under lib/ type-checks', () {
    // Reaching this point means every import above compiled.
    expect(true, isTrue);
  });
}
