...
// CaptionTrack now lives with the other models so the InnerTube player
// response can build it directly. Re-exported so existing imports of this
// file keep working.
export '../models/video.dart' show CaptionTrack;
...
class CaptionService {
  ...
  /// Fetch available caption tracks by scraping the watch page.
  ///
  /// This is now only a **fallback**: `VideoDetails.captionTracks` is filled
  /// from the InnerTube player response we already fetched, which avoids a
  /// 1-3 MB download per video and is not defeated by consent interstitials.
