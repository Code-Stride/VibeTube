...
class VideoFormat {
  ...
  /// IOS URL with an Android UA is a 403. Kept so playback can present the
...
/// Related videos + comments parsed from a single InnerTube `next` response.
class NextData {
  final List<Video> related;
  final List<Comment> comments;

  const NextData({required this.related, required this.comments});
}
