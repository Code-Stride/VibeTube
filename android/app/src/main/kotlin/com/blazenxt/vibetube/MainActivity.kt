...
class MainActivity : FlutterActivity() {
     ...
     * IllegalStateException when the app is in the background — and the throw
     * was swallowed with an empty catch, so play/pause state silently stopped
     * reaching the MediaSession and the notification desynced from playback
     ...
     * MethodChannel -> BinaryMessenger -> DartExecutor kept the whole
     * FlutterEngine and this Activity alive across every recreate, and a
     * service outliving the Activity pushed media-button callbacks into a dead
     * messenger where they were swallowed — the notification Play button just
     * stopped working.
     */
